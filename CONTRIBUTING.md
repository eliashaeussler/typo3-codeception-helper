...
```bash
# Clone repository
git clone https://github.com/eliashaeussler/typo3-codeception-helper.git
cd typo3-codeception-helper
...
Once the changes are ready, please [submit a pull request](https://github.com/eliashaeussler/typo3-codeception-helper/compare)
